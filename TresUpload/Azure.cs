		...
		void Btn_copyfilesClick(object sender, EventArgs e)
		{
			...
			if (fbd_copyfiles.ShowDialog() == DialogResult.OK) {
				...
				for (int i = 0; i < src_files.Length; i++) {
					//string sourcePath1 = directory_source + @"/UX/Portal/src/loc/BatchExtension.locbld/lba/"+ source_langcode_17[i] + "/BatchExtension/lcl/Client";
					//string targetPath1 = directory_target + @"/Azure Batch/" + target_langcode_17[i] + "/BatchExtension/lcl/Client";		        			
